...
import {useResponsiveText} from '@/hooks/useResponsiveText.tsx'
...
export const GithubProjectCard: React.FC<ProjectCardProps> = ({
                                                                  repo,
                                                                  darkMode
                                                              }) => {
    return (<div
        ...
        <div className="flex justify-between items-start mb-4">
            <h3 className="font-bold text-xl truncate">{useResponsiveText(repo.name)}</h3>
